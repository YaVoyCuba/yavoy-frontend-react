...
const HeaderCategories = () => {
  return (
    <div
      className="lg:h-48 xl:h-64 2xl:h-72 pt-3 pb-32 lg:px-14    "
      style={{
        backgroundImage: "url('/assets/img/headercategories.svg')",
        backgroundSize: "cover",
      }}
    >
      <div className="text-white -mt-7 lg:mt-0 px-6 flex scroll    space-x-6 ">
