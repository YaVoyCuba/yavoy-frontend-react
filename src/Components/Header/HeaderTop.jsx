        ...
        <div className="bg-white z-10  lg:relative top-0 py-3">
            <div className="flex text-sm text-gray-800   justify-between  ">
                <div className="flex cursor-pointer">
                    <Link
                        to={ { pathname: '/', search: 'location=' + locationParamsSearch } }
                    >
                        { ' ' }
                        <img
                            src="/assets/img/logoyavoy.png"
          ...
          <span className=" font-medium ">
            ¡Bienvenido a YaVoy MarketPlace!
          </span>
                </div>
                <div className="px-3 lg:space-x-5   flex">
                    ...
                    <div className="bg-white   sm:flex  ">
                        <div className="h-4 my-1 bg-white" style={ { width: 1 } }></div>
                    </div>
                    <div className="flex">
                        <Link to={ 'tiendas' }>
                            <div className="flex  cursor-pointer">
                                            ...
                                            <div className="relative  pt-20 lg:pt-0 lg:mt-24 flex-1 px-4 sm:px-6">
                                                <div className=" px-4 sm:px-6">
                                                    ...
                                                    >
                                                        ...
                                                        <Link to={{ pathname: '/restaurants', search: 'location='+locationParamsSearch }}>
                                                            <button
                                                                onClick={ () => setOpen( !open ) }
                                                                className="w-full px-7 text-lg color-main flex self-center justify-between  "
                                                            >
