...
function RestaurantPage() {
    ...
    async function getRestaurantDetails( restaurantSlug ) {
        try {
            ...
            if (json && json !== 500) {
                if (json.code === 'ok' && json.restaurant) {
    ...
    if (!restaurant || (Array.isArray(restaurant) && restaurant.length === 0)) {
        return (
            <div className="min-h-screen flex items-center justify-center">
                <p className="text-xl text-gray-600">Comercio no encontrado.</p>
            </div>
        );
    }
                ...
                >
                    <div className="flex flex-col lg:flex-row justify-between flex-wrap">
                        ...
                        <div className="inline-block  lg:hidden h-14 w-14 rounded-full   overflow-hidden bg-gray-100">
                            { restaurant.avatar && (
                                <img
                                    className="h-full mb-3 my-1 w-full"
                                    ...
                                    return (
                                        <div key={ category.id }>
                                            <div className="lg:grid mt-10 lg:p-5  lg:grid-cols-3">
                                                <div className="lg:col-span-1">
                        <span className="text-2xl ml-3 color font-sans font-medium">
